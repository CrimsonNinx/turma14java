...
public class produtos extends CadLoja {
	...
	//construtor 
	public produtos(String nomeProduto, String codProduto, double precoUnitario) {
		super();
	...
	public produtos(String nomeProduto, String codProduto, double precoUnitario, int qtdeProdutoEstoque) {
		super();
		this.nomeProduto = nomeProduto;
		this.codProduto = codProduto;
		this.precoUnitario = precoUnitario;
