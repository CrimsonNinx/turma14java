programa
{
	...
	funcao inicio()
	{
		...
		para (inteiro x=0; x<38; x++) //molejão
		{
			se ( aluno == matriculas[x])
			{
				...
				senao
				{
					escreva("\nA aluna escolhida foi : ", alunos[x]+"-Digite a nota do Aluno")
		...
		{
			escreva("\nDigite a nota(use ponto ao invés de vírgula): ")
			
			leia(nota)
	
			se (nota < 0 e nota > 10 ){
				escreva ("Insira uma nota válida entre 0 e 10."+"para o "+alunos[x])					
			}
